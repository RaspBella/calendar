pub mod crs {
    ...
    pub fn crs(code: &str) -> &'static str {
        match code {
            "ABW" => "Abbey Wood",
            "ABE" => "Aber",
            "ACY" => "Abercynon",
            ...
            "GLS" => "Glaisdale",
            "GCW" => "Glan Conwy",
            "GLW" => "Glasgow Central or Glasgow Queen Street",
            "GLC" => "Glasgow Central",
            ...
            "MLT" => "Malton",
            "MVL" => "Malvern Link",
            "MCR" => "Manchester Piccadilly, Victoria, Oxford Road or Deansgate",
            ...
            "WAD" => "Wadhurst",
            "WFL" => "Wainfleet",
            "WAK" => "Wakefield Westgate or Wakefield Kirkgate",
